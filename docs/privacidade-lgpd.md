...
SEFAZ MT: Reimpressão de Certidão Negativa de Débitos segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_mt_reimpressao_cnd@mcp.ai](mailto:sefaz_mt_reimpressao_cnd@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
